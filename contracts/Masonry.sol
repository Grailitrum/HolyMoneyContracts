...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        withdrawLockupEpochs = 3; // Lock for 3 epochs (24h) before release withdraw
        rewardLockupEpochs = 2; // Lock for 2 epochs (16h) before release claimReward
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            holy.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        holy.safeTransferFrom(msg.sender, address(this), amount);
